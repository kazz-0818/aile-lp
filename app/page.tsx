...
const companies: Company[] = [
  ...
  },
  {
    ...
    capabilities: [
      { name: "転売プラットフォーム「FLIP BASE」運営", href: "https://nlightningaile.com/flipbase/" },
  ...
  },
  {
    ...
    capabilities: [
      ...
      },
      {
        ...
        href: "https://www.instagram.com/salon_de.lilac",
        logo: "/logos/lilac.png",
        instagramHref: "https://www.instagram.com/salon_de.lilac",
      },
  ...
  },
  {
    ...
    nameJP: "株式会社 BRAVO",
    role: "アパレルブランド事業",
    roleLogo: "/logos/brandvox-logo-horizontal.png",

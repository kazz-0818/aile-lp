...
const companies: Company[] = [
  {
    ...
    evolutions: [
      { date: "2022-05", title: "第2期売上 3億4000万円 突破", desc: "動画・テスト形式での研修コンテンツを本格展開" },
      { date: "2021-05", title: "初年度売上 1億7000万円 突破", desc: "採用戦略立案から面接同席まで一気通貫でサポート" },
      { date: "2023-04", title: "営業代行業 開始", desc: "営業代行を中核サービスとして立ち上げ" },
  ...
  },
  {
    ...
    evolutions: [
      ...
      { date: "2024-05", title: "ライバーマネジメント事業運営", desc: "現役FPによる1on1メンタリングプランを追加" },
